const servicesAndProducts = `1 - Serviços e Produtos:

A InfyMedia é uma multinacional do grupo RadioSparx e a única no Brasil, que possui licenciamento junto ao ECAD e trata esses assuntos da forma correta e sem riscos!

A InfyMedia Brasil trabalha fornecendo serviço de rádio ambiente para diversos segmentos como: supermercados, farmácias, academias, lojas, clínicas, varejistas em geral e todo tipo de empresa que utilize rádio ambiente e comunicação interna como ferramenta de marketing.
Fornecemos um link de player com login e senha para cada loja acessar no computador, tablet ou celular (Android) que seja ligado ao sistema de som da loja. Depois disso, apertar “play” e toda a programação da sua rádio ambiente tocará automaticamente. O Serviço é todo online e digital e a plataforma funciona diretamente pelo navegador.
